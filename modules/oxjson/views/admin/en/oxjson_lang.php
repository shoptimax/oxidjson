...
$aLang = array(
    ...
    'SHOP_MODULE_GROUP_oxidjson'              => 'OXID|Json parameters',
    'SHOP_MODULE_aOxidJsonBlacklistKeys'      => 'do not return these field values (enter substring of field name, e.g. "password")',
